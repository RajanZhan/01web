...
jQuery.Joel = { 
	...
	*/
	ajax:function(type,url,data,callok,callerr) {
		...
		$.ajax({
				...
				success:function (info) {$.Joel.loading();if(info.status){$.Joel.alert('success',info.msg);callok(info);}else{$.Joel.alert('danger',info.msg);callerr(info);}}, //成功时执行Response函数
	...
	* */
	...
	closeLoading: function () {
		$("#Joel-loading-wrap").css('display','none');
	},
